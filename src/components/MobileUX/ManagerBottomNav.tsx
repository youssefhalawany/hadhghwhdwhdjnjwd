...
export function ManagerBottomNav({
  ...
  const QUICK_ACTIONS = [
    ...
    },
    {
      ...
      category: "financials",
      titleEn: "Cheques",
      titleAr: "الشيكات المؤجلة",
      subtitleEn: "Track company cheques",
      subtitleAr: "متابعة الشيكات وتواريخ الصرف",
      icon: FileCheck2,
      accent: '#10B981',
      path: "/financials/inputs/cheques",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "tmt-invoices",
      category: "financials",
      titleEn: "TMT Invoices",
      titleAr: "فواتير TMT",
      subtitleEn: "Fuel & vendor TMT logs",
      subtitleAr: "تسجيل ومتابعة فواتير المحروقات",
      icon: FileText,
      accent: '#F59E0B',
      path: "/financials/inputs/tmt-invoices",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "safe-report",
      category: "financials",
      titleEn: "Daily Safe Report",
      titleAr: "تقرير الخزنة اليومي",
      subtitleEn: "End of day safe summary",
      subtitleAr: "الملخص اليومي لحركة الخزينة",
      icon: LayoutDashboard,
      accent: '#E11D48',
      path: "/financials/inputs/safe-report",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "vendor-statements",
      category: "financials",
      titleEn: "Vendor Statements",
      titleAr: "كشوف حساب الموردين",
      subtitleEn: "Supplier account statement",
      subtitleAr: "مطابقة وكشف حساب كل مورد",
      icon: CreditCard,
      accent: '#8B5CF6',
      path: "/financial-reports/vendor-statements",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "month-summary",
      category: "financials",
      titleEn: "Month Summary",
      titleAr: "الملخص المالي الشهري",
      subtitleEn: "Monthly P&L & Cashflow",
      subtitleAr: "تقرير الأداء والتدفق المالي الشهري",
      icon: TrendingUp,
      accent: '#3B82F6',
      path: "/financial-reports/month-summary",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "end-shift-cash",
      category: "financials",
      titleEn: "End-Shift Cash",
      titleAr: "نقدية نهاية الوردية",
      subtitleEn: "Shift drawer balances",
      subtitleAr: "مطابقة نقدية تقفيل الوردية",
      icon: Banknote,
      accent: '#10B981',
      path: "/financial-reports/end-shift-cash",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "out-of-stock",
    ...
    },
    {
      id: "devices-control",
      category: "admin",
      titleEn: "Active Devices & Kiosk",
      titleAr: "الأجهزة المتصلة وقفل الشاشة",
      subtitleEn: "Live telemetry & remote PIN lock",
      subtitleAr: "التحكم عن بعد وقفل أجهزة الكاشير",
      icon: Lock,
      accent: '#EF4444',
      path: "/admin/devices",
      rolesAllowed: ["admin", "manager"],
    },
    {
      id: "label-designer",
      category: "products",
      titleEn: "Shelf Label Designer",
      titleAr: "تصميم وطباعة كروت الرف",
      subtitleEn: "Barcode & price tags",
      subtitleAr: "طباعة وتصميم باركود وبطاقات الأسعار",
      icon: Tag,
      accent: '#8B5CF6',
      path: "/label-designer",
      rolesAllowed: ["admin", "manager"],
    },
    {
      ...
      subtitleEn: "Track changes & deletions",
      subtitleAr: "سجل متابعة التعديلات والعمليات",
      icon: ShieldCheck,
      accent: '#64748B',
      path: "/audit-logs",
      rolesAllowed: ["admin"],
