          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-6 bg-black/80 backdrop-blur-md overflow-y-auto">
            <div className="bg-white dark:bg-[#0B1121] border border-slate-200 dark:border-[#1E293B] rounded-3xl w-full max-w-3xl overflow-hidden shadow-2xl text-slate-900 dark:text-slate-100 my-auto flex flex-col max-h-[90vh]">
              ...
              <div className="p-6 overflow-y-auto flex-1 bg-white text-slate-900 custom-scrollbar">
                ...
                <div id="official-doc-print-capture" className="space-y-6 text-slate-900">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b-2 border-slate-900">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-slate-500 tracking-widest uppercase">
                          Official Executive Dispatch & Records
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                      ...
                      <p className="text-[10px] text-slate-500 font-bold">
                        Date: {new Date(selectedDoc.createdAt).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs">
                        <div>
                          ...
                          <p className="font-extrabold text-slate-900">{selectedDoc.metadata.employeeName}</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase">Position / Role</p>
                          <p className="font-extrabold text-slate-900">{selectedDoc.metadata.employeeRole}</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase">Pay Period</p>
                          <p className="font-extrabold text-slate-900">{selectedDoc.metadata.month}</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase">Branch</p>
                          <p className="font-extrabold text-slate-900 capitalize">{selectedDoc.targetBranch}</p>
                        </div>
                      </div>
                      ...
                      <table className="w-full text-xs border-collapse border border-slate-300">
                        <thead>
                          <tr className="bg-slate-200 text-slate-900 font-black">
                            <th className="p-2.5 text-left border border-slate-300">Item Description</th>
                            <th className="p-2.5 text-right border border-slate-300">Amount (EGP)</th>
                          </tr>
                        </thead>
                        <tbody className="font-mono">
                          <tr>
                            <td className="p-2.5 border border-slate-300 font-sans font-bold">Base Monthly Salary</td>
                          ...
                          <tr>
                            <td className="p-2.5 border border-slate-300 font-sans font-bold">Bonuses & Allowances</td>
                          ...
                          <tr>
                            <td className="p-2.5 border border-slate-300 font-sans font-bold">Deductions / Advances</td>
                          ...
                          <tr className="bg-slate-100 font-black text-sm">
                            <td className="p-3 border border-slate-300 font-sans uppercase">TOTAL NET DISBURSED SALARY</td>
                  ...
                  {selectedDoc.note && (
                    <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs">
                      <p className="text-[10px] font-extrabold text-slate-400 uppercase">Remarks & Directives</p>
                  ...
                  {/* Executive Signature Block & Micro Security Border */}
                  <div className="pt-6 mt-6 border-t-2 border-slate-300 flex items-end justify-between">
                    <div>
                      <p className="text-[9px] font-mono text-slate-400 tracking-wider">
                        SERIAL: {selectedDoc.serialNumber} • STORE COPY
                      </p>
